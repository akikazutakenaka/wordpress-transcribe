 ...
 *
 * Uses sprintf to append the amount of zeros based on the $threshold parameter and the size of the number.
 ...
 *
 * NOTE: Since 4.8.3, '%' characters will be replaced with a placeholder string, this prevents certain SQLi attacks from taking place.
 * This change in behaviour may cause issues for code that expects the return value of esc_sql() to be useable for other purposes.
 *
 * @since  2.8.0
