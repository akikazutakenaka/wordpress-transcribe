 ...
 * ......->: wp-includes/class-http.php: WP_Http::browser_redirect_compatibility( string $location, array $headers, string|array $data, &array $options, Requests_Response $original )
 */
	}
 ...
 * @NOW 013: wp-includes/class-http.php: WP_Http::browser_redirect_compatibility( string $location, array $headers, string|array $data, &array $options, Requests_Response $original )
 */
	/**
