...
function update_option( $option, $value, $autoload = NULL )
{
	 ...
	 *
	 * Unserialized values will be adequate in most cases.
	 * If the unserialized data differs, the (maybe) serialized data is checked to avoid unnecessary database calls for otherwise identical object instances.
	 *
	...
	if ( NULL !== $autoload ) {
		$update_args['autoload'] = 'no' === $autoload || FALSE === $autoload
			? 'no'
			: 'yes';
	}
