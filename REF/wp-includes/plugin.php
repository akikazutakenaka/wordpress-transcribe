 ...
 *
 * @since  3.0.0
 * @see    apply_filters() This function is identical, but the arguments passed to the functions hooked to `$tag` are supplied using an array.
 * @global array $wp_filter         Stores all of the filters.
 * @global array $wp_current_filter Stores the list of current filters with the current one last.
 *
 * @param  string $tag  The name of the filter hook.
 ...
 *
 * Note: the value and extra arguments passed to the original apply_filters() call must be passed here to `$args` as an array.
 * For example:
 *
 *     // Old filter.
