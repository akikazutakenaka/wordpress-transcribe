...
// :
// refactored. function image_downsize( $id, $size = 'medium' ) {}
...
// refactored. function wp_constrain_dimensions( $current_width, $current_height, $max_width = 0, $max_height = 0 ) {}
...
// refactored. function image_get_intermediate_size( $post_id, $size = 'thumbnail' ) {}
...
// refactored. function wp_get_attachment_image($attachment_id, $size = 'thumbnail', $icon = false, $attr = '') {}
...
// refactored. function _wp_get_attachment_relative_path( $file ) {}
// refactored. function _wp_get_image_size_from_meta( $size_name, $image_meta ) {}
...
// refactored. function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {}
...
// refactored. function wp_audio_shortcode( $attr, $content = '' ) {}
add_shortcode( 'audio', 'wp_audio_shortcode' );

// refactored. function wp_get_video_extensions() {}
// refactored. function wp_video_shortcode( $attr, $content = '' ) {}
...
// refactored. function get_attachment_taxonomies( $attachment, $output = 'names' ) {}
// refactored. function get_taxonomies_for_attachments( $output = 'names' ) {}
