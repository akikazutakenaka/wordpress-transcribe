...
// :
// refactored. function sanitize_title_for_query( $title ) {}
...
// refactored. function translate_smiley( $matches ) {}
// refactored. function convert_smilies( $text ) {}
...
// refactored. function get_gmt_from_date( $string, $format = 'Y-m-d H:i:s' ) {}
// refactored. function get_date_from_gmt( $string, $format = 'Y-m-d H:i:s' ) {}
...
// refactored. function esc_sql( $data ) {}
// :
...
// refactored. function esc_js( $text ) {}
// :
// refactored. function esc_textarea( $text ) {}
