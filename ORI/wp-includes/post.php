...
// :
// refactored. function get_children( $args = '', $output = OBJECT ) {}
...
// :
// refactored. function get_post_field( $field, $post = null, $context = 'display' ) {}
...
// refactored. function get_post_status( $ID = '' ) {}
...
// refactored. function wp_insert_post( $postarr, $wp_error = false ) {}
// refactored. function wp_update_post( $postarr = array(), $wp_error = false ) {}
...
// refactored. function wp_unique_post_slug( $slug, $post_ID, $post_status, $post_type, $post_parent ) {}
...
// refactored. function wp_set_post_tags( $post_id = 0, $tags = '', $append = false ) {}
// :
// refactored. function wp_transition_post_status( $new_status, $old_status, $post ) {}
...
// refactored. function get_page_by_path( $page_path, $output = OBJECT, $post_type = 'page' ) {}
...
// refactored. function wp_insert_attachment( $args, $file = false, $parent = 0, $wp_error = false ) {}
...
// :
// refactored. function wp_mime_type_icon( $mime = 0 ) {}
...
// refactored. function wp_check_post_hierarchy_for_loops( $post_parent, $post_ID ) {}
...
// refactored. function wp_queue_posts_for_term_meta_lazyload( $posts ) {}
